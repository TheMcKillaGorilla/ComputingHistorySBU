...
function PioneerTabs() {
  ...
  return (
    <Paper square className={classes.root}>
      ...
      >
        <Tab icon={<iframe  className={classes.video} alt="complex" src={ "https://www.youtube.com/embed/GWbla-pQnCI" } />} aria-label="phone" />
        <Tab icon={<iframe  className={classes.video} alt="complex" src={ "https://www.youtube.com/embed/12BK4THxLIU" } />} aria-label="favorite" />
        <Tab icon={<iframe  className={classes.video} alt="complex" src={ "https://www.youtube.com/embed/hAy5eKoA9Kk" } />} aria-label="person" />
      </Tabs>
    </Paper>
  );
}
  ...
  return (
    <Paper square className={classes.root}>
      <Tabs
        ...
        aria-label="icon tabs example"
      >
        <Tab icon={<img className={classes.img} src={image1}/>} aria-label="phone" />
        <Tab icon={<img className={classes.img} src={image2} />} aria-label="favorite" />
        <Tab icon={<img className={classes.img} src={image3} />} aria-label="person" />
      </Tabs>
    </Paper>
  );
}
